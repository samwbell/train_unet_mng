...
if True:
	...
	t1 = time.time()
	file_list = sorted(glob.glob('cropped/1898.1.png'))
...
if True:
	print('Filling holes...')
	t1 = time.time()
	file_list = sorted(glob.glob('binary/1898.1.png'))
	for file in file_list:
		fill_holes(file)
	t2 = time.time()
	print('Done in: ' + str(round(t2-t1, 3)) + ' s')
...
if True:
	...
	t1 = time.time()
	file_list = sorted(glob.glob('filled/1898.1.png'))
	for file in file_list:
		despeckle(file)
	t2 = time.time()
	print('Done in: ' + str(round(t2-t1, 3)) + ' s')
...
if True:
	print('Filtering...')
	t1 = time.time()
	file_list = sorted(glob.glob('despeckled/1898.1.png'))
	for file in file_list:
		filter(file, 2623.2*0.8/downsize**2, 0.20)
	t2 = time.time()
	print('Done in: ' + str(round(t2-t1, 3)) + ' s')
